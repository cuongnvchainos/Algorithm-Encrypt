...
public class GenerateRSA_PairKey {
	...
	public GenerateRSA_PairKey(int keylength) throws NoSuchAlgorithmException, NoSuchProviderException {
	...
	public static void main(String[] args) {
		try {
			new GenerateRSA_PairKey(1024).generateKeysToFile();
